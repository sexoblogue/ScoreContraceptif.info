...
<p>
        ...
        La <span style={{ fontWeight: 'bold', color: 'red' }}><a href="https://docs.google.com/spreadsheets/d/1tXczMFTPnqmLjM3ZziWKvOsGdRV_hmPL-I51muQBcNA/edit#gid=0" target="_blank">première version</a></span> date du <span style={{ fontWeight: 'bold', color: 'green' }}>12/06/2020</span>.<br/>La <span style={{ fontWeight: 'bold', color: 'orange' }}>dernière version</span> est le fruit de la collaboration entre le Dr Arnaud Zeler, la société <a href="https://produits.outils-du-sexologue.fr/sexologues" target="_blank">SAS SEXOBLOGUE</a> et le Dr Alan Charissou entre  <span style={{ fontWeight: 'bold', color: 'green' }}>juin et octobre 2023</span>.
</p>
      <h3 style={{ color: 'green' }}>Conception de l'application Web</h3>
<p>L'application actuelle a été codée en react.js par <span style={{ fontWeight: 'bold', color: 'orange' }}><a href="https://www.codeur.com/-haroldgq0nm" target="_blank">Harold Goundou</a> et Arnaud ZELER</span>. Elle a été mise en ligne le <span style={{ fontWeight: 'bold', color: 'green' }}>26/09/2023</span>.<br/>
      ...
      <h3 style={{ color: 'orange' }}>Financement</h3>
          <a href="https://www.meurthe-et-moselle.fr" target="_blank"><img  class="financement" src={conseilDepartemental} alt="Conseil Départemental de Meurthe-et-Moselle" width="200px"/></a>
          <a href="https://sexoblogue.fr" target="_blank"><img  class="financement" width="200px" src="https://sexoblogue.fr/wp-content/uploads/logo-sexoblogue-150-carre.jpg" alt="Sexoblogue" /></a><br/> 
